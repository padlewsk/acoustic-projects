...
PRODUCT_NAME              = SG__MDL_DMA
MAKEFILE                  = SG__MDL_DMA.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/padlewsk/Desktop/acoustic-projects/wavebit/experimental/speedgoat/20240624__cnot
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C++
...
PRODUCT = $(START_DIR)/SG__MDL_DMA_slrealtime_rtw/SG__MDL_DMA
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/SG__MDL_DMA_slrealtime_rtw -I$(MATLAB_ROOT)/toolbox/slrealtime/simulink/blocks/dist/include -I$(MATLAB_ROOT)/toolbox/slrealtime/target/kernel/dist/include -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2022b/971~1.1/SG_BLO~1/common/libsg -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2022b/971~1.1 -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2022b/971~1.1/SG_BLO~1/analog/include -I$(START_DIR)/SG__MDL_DMA_slrealtime_rtw/instrumented
...
DEFINES_STANDARD = -DMODEL=SG__MDL_DMA -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_matrx.c $(MATLAB_ROOT)/rtw/c/src/rt_printf.c $(START_DIR)/SG__MDL_DMA_slrealtime_rtw/SG__MDL_DMA.cpp $(START_DIR)/SG__MDL_DMA_slrealtime_rtw/SG__MDL_DMA_cal.cpp $(START_DIR)/SG__MDL_DMA_slrealtime_rtw/rtGetInf.cpp $(START_DIR)/SG__MDL_DMA_slrealtime_rtw/rtGetNaN.cpp $(START_DIR)/SG__MDL_DMA_slrealtime_rtw/rt_nonfinite.cpp $(START_DIR)/SG__MDL_DMA_slrealtime_rtw/slrealtime_datatype_ground.cpp $(START_DIR)/SG__MDL_DMA_slrealtime_rtw/rte_SG__MDL_DMA_parameters.cpp $(START_DIR)/SG__MDL_DMA_slrealtime_rtw/main.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2022b/9.7.1.1/sg_blocks/analog/sg_IO132_IO133_ad_s_v2.c C:/ProgramData/Speedgoat/speedgoatlib/R2022b/9.7.1.1/sg_blocks/analog/sg_IO132_IO133_da_s_v2.c C:/ProgramData/Speedgoat/speedgoatlib/R2022b/9.7.1.1/sg_blocks/analog/sg_IO132_IO133_setup_s_v2.c C:/ProgramData/Speedgoat/speedgoatlib/R2022b/9.7.1.1/sg_blocks/analog/src/sg_io132.c host_timer_x86.c slrealtime_code_profiling_utility_functions.cpp
...
OBJS = rt_matrx.o rt_printf.o SG__MDL_DMA.o SG__MDL_DMA_cal.o rtGetInf.o rtGetNaN.o rt_nonfinite.o slrealtime_datatype_ground.o rte_SG__MDL_DMA_parameters.o main.o sg_IO132_IO133_ad_s_v2.o sg_IO132_IO133_da_s_v2.o sg_IO132_IO133_setup_s_v2.o sg_io132.o host_timer_x86.o slrealtime_code_profiling_utility_functions.o
...
%.o : $(START_DIR)/SG__MDL_DMA_slrealtime_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/SG__MDL_DMA_slrealtime_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/SG__MDL_DMA_slrealtime_rtw/instrumented/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/SG__MDL_DMA_slrealtime_rtw/instrumented/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
SG__MDL_DMA.o : $(START_DIR)/SG__MDL_DMA_slrealtime_rtw/SG__MDL_DMA.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


SG__MDL_DMA_cal.o : $(START_DIR)/SG__MDL_DMA_slrealtime_rtw/SG__MDL_DMA_cal.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetInf.o : $(START_DIR)/SG__MDL_DMA_slrealtime_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetNaN.o : $(START_DIR)/SG__MDL_DMA_slrealtime_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rt_nonfinite.o : $(START_DIR)/SG__MDL_DMA_slrealtime_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


slrealtime_datatype_ground.o : $(START_DIR)/SG__MDL_DMA_slrealtime_rtw/slrealtime_datatype_ground.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rte_SG__MDL_DMA_parameters.o : $(START_DIR)/SG__MDL_DMA_slrealtime_rtw/rte_SG__MDL_DMA_parameters.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


main.o : $(START_DIR)/SG__MDL_DMA_slrealtime_rtw/main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<

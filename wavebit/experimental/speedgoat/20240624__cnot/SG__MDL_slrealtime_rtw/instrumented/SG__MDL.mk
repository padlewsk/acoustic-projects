...
## 
## Makefile     : SG__MDL.mk
## Generated on : Wed Jun 26 16:38:47 2024
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_matrx.c $(MATLAB_ROOT)/rtw/c/src/rt_printf.c $(START_DIR)/SG__MDL_slrealtime_rtw/SG__MDL.cpp $(START_DIR)/SG__MDL_slrealtime_rtw/SG__MDL_cal.cpp $(START_DIR)/SG__MDL_slrealtime_rtw/rtGetInf.cpp $(START_DIR)/SG__MDL_slrealtime_rtw/rtGetNaN.cpp $(START_DIR)/SG__MDL_slrealtime_rtw/rt_nonfinite.cpp $(START_DIR)/SG__MDL_slrealtime_rtw/slrealtime_datatype_ground.cpp $(START_DIR)/SG__MDL_slrealtime_rtw/rte_SG__MDL_parameters.cpp $(START_DIR)/SG__MDL_slrealtime_rtw/main.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2022b/9.7.1.1/sg_blocks/analog/sg_IO132_IO133_ad_s_v2.c C:/ProgramData/Speedgoat/speedgoatlib/R2022b/9.7.1.1/sg_blocks/analog/sg_IO132_IO133_da_s_v2.c C:/ProgramData/Speedgoat/speedgoatlib/R2022b/9.7.1.1/sg_blocks/analog/sg_IO132_IO133_setup_s_v2.c C:/ProgramData/Speedgoat/speedgoatlib/R2022b/9.7.1.1/sg_blocks/analog/src/sg_io132.c host_timer_x86.c slrealtime_code_profiling_utility_functions.cpp
...
OBJS = rt_matrx.o rt_printf.o SG__MDL.o SG__MDL_cal.o rtGetInf.o rtGetNaN.o rt_nonfinite.o slrealtime_datatype_ground.o rte_SG__MDL_parameters.o main.o sg_IO132_IO133_ad_s_v2.o sg_IO132_IO133_da_s_v2.o sg_IO132_IO133_setup_s_v2.o sg_io132.o host_timer_x86.o slrealtime_code_profiling_utility_functions.o
...
%.o : $(START_DIR)/SG__MDL_slrealtime_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/SG__MDL_slrealtime_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
SG__MDL.o : $(START_DIR)/SG__MDL_slrealtime_rtw/SG__MDL.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


SG__MDL_cal.o : $(START_DIR)/SG__MDL_slrealtime_rtw/SG__MDL_cal.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetInf.o : $(START_DIR)/SG__MDL_slrealtime_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetNaN.o : $(START_DIR)/SG__MDL_slrealtime_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rt_nonfinite.o : $(START_DIR)/SG__MDL_slrealtime_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


slrealtime_datatype_ground.o : $(START_DIR)/SG__MDL_slrealtime_rtw/slrealtime_datatype_ground.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rte_SG__MDL_parameters.o : $(START_DIR)/SG__MDL_slrealtime_rtw/rte_SG__MDL_parameters.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


main.o : $(START_DIR)/SG__MDL_slrealtime_rtw/main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<

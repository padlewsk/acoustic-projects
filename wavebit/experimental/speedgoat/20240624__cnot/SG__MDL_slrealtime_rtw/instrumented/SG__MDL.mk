...
OBJS = rt_matrx.o rt_printf.o SG__MDL.o SG__MDL_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o slrealtime_datatype_ground.o main.o sg_IO132_IO133_ad_s_v2.o sg_IO132_IO133_da_s_v2.o sg_IO132_IO133_setup_s_v2.o sg_io132.o host_timer_x86.o slrealtime_code_profiling_utility_functions.o
...
SG__MDL_data.o : $(START_DIR)/SG__MDL_slrealtime_rtw/SG__MDL_data.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<

...
MODEL           = tf_Pb_Xi__SG
MODULES         = rt_matrx.c rt_printf.c rt_logging.c rtGetInf.c rtGetNaN.c rt_nonfinite.c tf_Pb_Xi__SG.c tf_Pb_Xi__SG_capi.c tf_Pb_Xi__SG_data.c tf_Pb_Xi__SG_xcp.c tf_Pb_Xi__SG_xcp_TET.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c host_timer_x86.c xpc_code_profiling_utility_functions.c sg_fpga_HDLCoder_io334_dac_sf_1.c sg_fpga_HDLCoder_io334_i2c_sf_1.c
MAKEFILE        = tf_Pb_Xi__SG.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = \\files7\data\padlewsk\My Documents\PhD_local\Projects\SpeedGoat\tf_Pb_Xi\build
S_FUNCTIONS_LIB = C:\ProgramData\Speedgoat\hdlc\hcip\R2020a\sfunc\lib\libsghdlcutils_MSVC150_vc.lib C:\ProgramData\Speedgoat\speedgoatlib\R2020a\8.28.4\sg_blocks\common\libsg\libsg_MSVC150_vc.lib
NUMST           = 1
TID01EQ         = 0
NCSTATES        = 0
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = tf_Pb_Xi__SG_ref.rsp
COMPILER_COMMAND_FILE     = tf_Pb_Xi__SG_comp.rsp
...
{C:\ProgramData\Speedgoat\speedgoatlib\R2020a\8.28.4}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{C:\ProgramData\Speedgoat\hdlc\hcip\R2020a\hookFiles}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{$(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{C:\ProgramData\Speedgoat\hdlc\hcip\R2020a\sfunc}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{$(START_DIR)\tf_Pb_Xi__SG_slrt_rtw}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{$(MATLAB_ROOT)\rtw\c\src}.c.obj :
	@cmd /C "echo ### Compiling $<"
...
sg_fpga_HDLCoder_io334_dac_sf_1.obj : C:\ProgramData\Speedgoat\hdlc\hcip\R2020a\sfunc\sg_fpga_HDLCoder_io334_dac_sf_1.c
	@cmd /C "echo ### Compiling C:\ProgramData\Speedgoat\hdlc\hcip\R2020a\sfunc\sg_fpga_HDLCoder_io334_dac_sf_1.c
	$(CC) $(CFLAGS) C:\ProgramData\Speedgoat\hdlc\hcip\R2020a\sfunc\sg_fpga_HDLCoder_io334_dac_sf_1.c
sg_fpga_HDLCoder_io334_i2c_sf_1.obj : C:\ProgramData\Speedgoat\hdlc\hcip\R2020a\sfunc\sg_fpga_HDLCoder_io334_i2c_sf_1.c
	@cmd /C "echo ### Compiling C:\ProgramData\Speedgoat\hdlc\hcip\R2020a\sfunc\sg_fpga_HDLCoder_io334_i2c_sf_1.c
	$(CC) $(CFLAGS) C:\ProgramData\Speedgoat\hdlc\hcip\R2020a\sfunc\sg_fpga_HDLCoder_io334_i2c_sf_1.c


{C:\ProgramData\Speedgoat\speedgoatlib\R2020a\8.28.4}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<

{C:\ProgramData\Speedgoat\hdlc\hcip\R2020a\hookFiles}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<
...
{C:\ProgramData\Speedgoat\hdlc\hcip\R2020a\sfunc}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<

{$(START_DIR)\tf_Pb_Xi__SG_slrt_rtw}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<

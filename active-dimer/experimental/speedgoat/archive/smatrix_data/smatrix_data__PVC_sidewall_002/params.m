...
fs = 2^14;  %% fs = 2^15; sampling frequency (Hz) %% performance: max 100000 Hz; Baseline: 50000 Kz % must be integer multiple of max freq val
ts = 1/fs; %% % sampling time (s) %%% CANNOT CHANGE ONCE FLASHED
%% SOURCE GENERATOR %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
A = 0.15; %% source amplitude (V) Tannoy: 0.02 (V)%Duct speaker: 0.2 (V)
tmax = 20; %%20 sweep up measurement time (s) 
...
%%% Unit Cell 
a = 0.2806; %m 
offset = -0.1403; %m %shift of centre of unit cell wrt centre
%a = 0.055; %m
...
sens_p_c =  22.6E-3; % (V/Pa) SN6993
sens_p_p =  29.06E-3;% (V/Pa) SN5673 
...
muM_m = 0.99;%0.4 %%%(NOT STABLE <1)!!!
muR_m = 1;%(346.13*1.1839/(Rms_m/Sd));%0.5;
muC_m = 0.815;%0.4;

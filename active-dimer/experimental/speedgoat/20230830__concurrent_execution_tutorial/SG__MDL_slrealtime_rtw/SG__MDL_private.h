...
#define rtmSetTPtr(rtm, val) ((rtm)->Timing.t = (val))
                ...
                extern void SG__MDL_Subsystem(RT_MODEL_SG__MDL_T * const SG__MDL_M, B_Subsystem_SG__MDL_T *localB, DW_Subsystem_SG__MDL_T *localDW, SG__MDL_Subsystem_cal_type *SG__MDL_PageSwitching_arg);

...
void Periodic_Task_step(void)          /* Sample time: [0.0001s, 0.0s] */
{
  ...
  profileStart_SG_MDL(1U); /* original_line:134 */SG__MDL_Subsystem(task_M[0], &SG__MDL_B.Subsystem, &SG__MDL_DW.Subsystem,
                    &SG__MDL_cal->SG__MDL_Subsystem_cal);profileEnd_SG_MDL(1U); /* original_line:135 */
...
void Periodic_Task1_step(void)         /* Sample time: [0.0001s, 0.0s] */
{
  ...
  profileStart_SG_MDL(2U); /* original_line:167 */SG__MDL_Subsystem(task_M[1], &SG__MDL_B.Subsystem1, &SG__MDL_DW.Subsystem1,
                    &SG__MDL_cal->SG__MDL_Subsystem1_cal);profileEnd_SG_MDL(2U); /* original_line:168 */
...
void Periodic_Task2_step(void)         /* Sample time: [0.0001s, 0.0s] */
{
  ...
  profileStart_SG_MDL(3U); /* original_line:200 */SG__MDL_Subsystem(task_M[2], &SG__MDL_B.Subsystem2, &SG__MDL_DW.Subsystem2,
                    &SG__MDL_cal->SG__MDL_Subsystem2_cal);profileEnd_SG_MDL(3U); /* original_line:201 */
...
void Periodic_Task3_step(void)         /* Sample time: [0.0001s, 0.0s] */
{
  ...
  profileStart_SG_MDL(4U); /* original_line:233 */SG__MDL_Subsystem(task_M[3], &SG__MDL_B.Subsystem3, &SG__MDL_DW.Subsystem3,
                    &SG__MDL_cal->SG__MDL_Subsystem3_cal);profileEnd_SG_MDL(4U); /* original_line:234 */
...
void Periodic_Task4_step(void)         /* Sample time: [0.0001s, 0.0s] */
{
...

  {
    ...
    rtb_TmpTaskTransAtSubsystem4Inp = SG__MDL_DW.TmpTaskTransAtSubsystemOutport1;

    /* TaskTransBlk generated from: '<Root>/Subsystem4' */
    rtw_slrealtime_sem_wait(SG__MDL_DW.sw_buf_2);
    rtb_TmpTaskTransAtSubsystem4I_l = SG__MDL_DW.TmpTaskTransAtSubsystem1Outport;

    /* TaskTransBlk generated from: '<Root>/Subsystem4' */
    rtw_slrealtime_sem_wait(SG__MDL_DW.sw_buf_3);
    rtb_TmpTaskTransAtSubsystem4_k2 = SG__MDL_DW.TmpTaskTransAtSubsystem2Outport;
     ...
     *  TaskTransBlk generated from: '<Root>/Subsystem4'
     */
    profileStart_SG_MDL(5U); /* original_line:294 */SG__REF_IO(&rtb_TmpTaskTransAtSubsystem4Inp,
               &rtb_TmpTaskTransAtSubsystem4I_l,
               &rtb_TmpTaskTransAtSubsystem4_k2,
               &SG__MDL_DW.TmpTaskTransAtSubsystem3Outport, &rtb_Subsystem4_o1,
               &rtb_Subsystem4_o2, &rtb_Subsystem4_o3, &rtb_Subsystem4_o4);profileEnd_SG_MDL(5U); /* original_line:298 */
  }
...
void SG__MDL_initialize(void)
{
...

  {
    ...
    {                                  /* child S-Function registration */
      ...
      rtssSetDerivCacheNeedsResetPtr(sfcnInfo[0], &task_M[4]
      ...
      rtssSetContTimeOutputInconsistentWithStateAtMajorStepPtr(sfcnInfo[0],
        &task_M[4]->CTOutputIncnstWithState);
  ...
  SG__REF_IO_initialize(rtmGetErrorStatusPointer(SG__MDL_M),
                        rtmGetStopRequestedPtr(SG__MDL_M), &(task_M[4]
  ...
  profileStart_SG_MDL(6U); /* original_line:481 */SG__REF_IO_Init();profileEnd_SG_MDL(6U); /* original_line:481 */

  /* Enable for Atomic SubSystem: '<Root>/Subsystem1' */
  profileStart_SG_MDL(7U); /* original_line:484 */SG__MDL_Subsystem_Enable(&SG__MDL_DW.Subsystem1);profileEnd_SG_MDL(7U); /* original_line:484 */

  /* End of Enable for SubSystem: '<Root>/Subsystem1' */

  /* Enable for Atomic SubSystem: '<Root>/Subsystem2' */
  profileStart_SG_MDL(8U); /* original_line:489 */SG__MDL_Subsystem_Enable(&SG__MDL_DW.Subsystem2);profileEnd_SG_MDL(8U); /* original_line:489 */

  /* End of Enable for SubSystem: '<Root>/Subsystem2' */

  /* Enable for Atomic SubSystem: '<Root>/Subsystem3' */
  profileStart_SG_MDL(9U); /* original_line:494 */SG__MDL_Subsystem_Enable(&SG__MDL_DW.Subsystem3);profileEnd_SG_MDL(9U); /* original_line:494 */

  /* End of Enable for SubSystem: '<Root>/Subsystem3' */

  /* Enable for Atomic SubSystem: '<Root>/Subsystem' */
  profileStart_SG_MDL(10U); /* original_line:499 */SG__MDL_Subsystem_Enable(&SG__MDL_DW.Subsystem);profileEnd_SG_MDL(10U); /* original_line:499 */
...
void SG__MDL_terminate(void)
{
  ...
  profileStart_SG_MDL(11U); /* original_line:528 */SG__REF_IO_Term();profileEnd_SG_MDL(11U); /* original_line:528 */

...
void Periodic_Task_step(void)          /* Sample time: [0.0001s, 0.0s] */
{
  ...
  profileStart_SG_MDL(1U); /* original_line:161 */SG__MDL_Subsystem(task_M[0], &SG__MDL_B.Subsystem, &SG__MDL_DW.Subsystem,
                    &SG__MDL_cal->SG__MDL_Subsystem_cal);profileEnd_SG_MDL(1U); /* original_line:162 */
...
void Periodic_Task1_step(void)         /* Sample time: [0.0001s, 0.0s] */
{
  ...
  profileStart_SG_MDL(2U); /* original_line:194 */SG__MDL_Subsystem(task_M[1], &SG__MDL_B.Subsystem1, &SG__MDL_DW.Subsystem1,
                    &SG__MDL_cal->SG__MDL_Subsystem1_cal);profileEnd_SG_MDL(2U); /* original_line:195 */
...
void Periodic_Task2_step(void)         /* Sample time: [0.0001s, 0.0s] */
{
  ...
  profileStart_SG_MDL(3U); /* original_line:227 */SG__MDL_Subsystem(task_M[2], &SG__MDL_B.Subsystem2, &SG__MDL_DW.Subsystem2,
                    &SG__MDL_cal->SG__MDL_Subsystem2_cal);profileEnd_SG_MDL(3U); /* original_line:228 */
...
void Periodic_Task3_step(void)         /* Sample time: [0.0001s, 0.0s] */
{
  ...
  profileStart_SG_MDL(4U); /* original_line:260 */SG__MDL_Subsystem(task_M[3], &SG__MDL_B.Subsystem3, &SG__MDL_DW.Subsystem3,
                    &SG__MDL_cal->SG__MDL_Subsystem3_cal);profileEnd_SG_MDL(4U); /* original_line:261 */
...
void Periodic_Task4_step(void)         /* Sample time: [0.0001s, 0.0s] */
{
  ...
  profileStart_SG_MDL(5U); /* original_line:313 */SG__MDL_forallsubsystems();profileEnd_SG_MDL(5U); /* original_line:313 */
...
void Periodic_Task5_step(void)         /* Sample time: [0.0001s, 0.0s] */
{
...

  {
     ...
     *  TaskTransBlk generated from: '<Root>/Subsystem4'
     */
    profileStart_SG_MDL(6U); /* original_line:387 */SG__REF_IO(&rtb_TmpTaskTransAtSubsystem4Inp,
               ...
               &rtb_Subsystem4_o2, &rtb_Subsystem4_o3, &rtb_Subsystem4_o4);profileEnd_SG_MDL(6U); /* original_line:391 */
  }
...
void SG__MDL_initialize(void)
{
  ...
  profileStart_SG_MDL(7U); /* original_line:587 */SG__REF_IO_Init();profileEnd_SG_MDL(7U); /* original_line:587 */

  /* Enable for Atomic SubSystem: '<Root>/Subsystem1' */
  profileStart_SG_MDL(8U); /* original_line:590 */SG__MDL_Subsystem_Enable(&SG__MDL_DW.Subsystem1);profileEnd_SG_MDL(8U); /* original_line:590 */

  /* End of Enable for SubSystem: '<Root>/Subsystem1' */

  /* Enable for Atomic SubSystem: '<Root>/Subsystem2' */
  profileStart_SG_MDL(9U); /* original_line:595 */SG__MDL_Subsystem_Enable(&SG__MDL_DW.Subsystem2);profileEnd_SG_MDL(9U); /* original_line:595 */

  /* End of Enable for SubSystem: '<Root>/Subsystem2' */

  /* Enable for Atomic SubSystem: '<Root>/Subsystem3' */
  profileStart_SG_MDL(10U); /* original_line:600 */SG__MDL_Subsystem_Enable(&SG__MDL_DW.Subsystem3);profileEnd_SG_MDL(10U); /* original_line:600 */

  /* End of Enable for SubSystem: '<Root>/Subsystem3' */

  /* Enable for Atomic SubSystem: '<Root>/Subsystem' */
  profileStart_SG_MDL(11U); /* original_line:605 */SG__MDL_Subsystem_Enable(&SG__MDL_DW.Subsystem);profileEnd_SG_MDL(11U); /* original_line:605 */
...
void SG__MDL_terminate(void)
{
  ...
  profileStart_SG_MDL(12U); /* original_line:646 */SG__REF_IO_Term();profileEnd_SG_MDL(12U); /* original_line:646 */

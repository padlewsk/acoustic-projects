...
load('./__data/H31_corr.mat');
load('./__data/H41_corr.mat');
%load('./__data/freq.mat'); %correction frequency vector (could be a different length than the new data)

%%% RAW DATA
load('C:/Speedgoat/temp/H21_a.mat'); 
load('C:/Speedgoat/temp/H31_a.mat');
load('C:/Speedgoat/temp/H41_a.mat');

%%% CORRELATION
load('C:/Speedgoat/temp/C21_a.mat');
load('C:/Speedgoat/temp/C31_a.mat');
load('C:/Speedgoat/temp/C41_a.mat');

H11_a = ones(p.N,1); %CORRECTED SMOOTHING??? HERE?
H21_a = H21_a./H21_corr;
H31_a = H31_a./H31_corr;
H41_a = H41_a./H41_corr;
...
figure(3);
semilogy(p.freq, C21_a, 'DisplayName', 'C_{21}','LineWidth',2);
hold on;
semilogy(p.freq, C31_a, 'DisplayName', 'C_{31}','LineWidth',2);
semilogy(p.freq, C41_a, 'DisplayName', 'C_{41}','LineWidth',2);
legend show;
ylim([0,1])
xlabel("Frequency (Hz)")
box on

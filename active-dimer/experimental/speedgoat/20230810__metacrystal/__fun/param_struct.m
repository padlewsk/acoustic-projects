function params = param_struct();
    ...
    %%% ms_estimate:  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % 11: R = 7.43
    params.Bl(1,1)  =  1.58e+00;
    params.Rms(1,1) =  3.54e-01;
    params.Mms(1,1) =  7.22e-04; 
    params.Cmc(1,1) =  2.14e-04; 
    % 12: R = 7.43
    params.Bl(1,2)  =  1.58e+00;
    params.Rms(1,2) =  3.54e-01;
    params.Mms(1,2) =  7.22e-04; 
    params.Cmc(1,2) =  2.14e-04; 
    
    % 21: R = 7.43
    params.Bl(2,1)  =  1.58e+00;
    params.Rms(2,1) =  3.54e-01;
    params.Mms(2,1) =  7.22e-04; 
    params.Cmc(2,1) =  2.14e-04; 
    % 22: R = 7.43
    params.Bl(2,2)  =  1.58e+00;
    params.Rms(2,2) =  3.54e-01;
    params.Mms(2,2) =  7.22e-04; 
    params.Cmc(2,2) =  2.14e-04; 
    
    % 31: R = 7.43
    params.Bl(3,1)  =  1.58e+00;
    params.Rms(3,1) =  3.54e-01;
    params.Mms(3,1) =  7.22e-04; 
    params.Cmc(3,1) =  2.14e-04; 
    % 32: R = 7.43
    params.Bl(3,2)  =  1.58e+00;
    params.Rms(3,2) =  3.54e-01;
    params.Mms(3,2) =  7.22e-04; 
    params.Cmc(3,2) =  2.14e-04; 

    % 41: R = 7.43
    params.Bl(4,1)  =  1.58e+00;
    params.Rms(4,1) =  3.54e-01;
    params.Mms(4,1) =  7.22e-04; 
    params.Cmc(4,1) =  2.14e-04; 
    % 42: R = 7.43
    params.Bl(4,2)  =  1.58e+00;
    params.Rms(4,2) =  3.54e-01;
    params.Mms(4,2) =  7.22e-04; 
    params.Cmc(4,2) =  2.14e-04; 

    % 51: R = 7.43
    params.Bl(5,1)  =  1.58e+00;
    params.Rms(5,1) =  3.54e-01;
    params.Mms(5,1) =  7.22e-04; 
    params.Cmc(5,1) =  2.14e-04; 
    % 52: R = 7.43
    params.Bl(5,2)  =  1.58e+00;
    params.Rms(5,2) =  3.54e-01;
    params.Mms(5,2) =  7.22e-04; 
    params.Cmc(5,2) =  2.14e-04; 

    % 61: R = 7.43
    params.Bl(6,1)  =  1.58e+00;
    params.Rms(6,1) =  3.54e-01;
    params.Mms(6,1) =  7.22e-04; 
    params.Cmc(6,1) =  2.14e-04; 
    % 62: R = 7.43
    params.Bl(6,2)  =  1.58e+00;
    params.Rms(6,2) =  3.54e-01;
    params.Mms(6,2) =  7.22e-04; 
    params.Cmc(6,2) =  2.14e-04; 

    % 71: R = 7.43
    params.Bl(7,1)  =  1.58e+00;
    params.Rms(7,1) =  3.54e-01;
    params.Mms(7,1) =  7.22e-04; 
    params.Cmc(7,1) =  2.14e-04; 
    % 72: R = 7.43
    params.Bl(7,2)  =  1.58e+00;
    params.Rms(7,2) =  3.54e-01;
    params.Mms(7,2) =  7.22e-04; 
    params.Cmc(7,2) =  2.14e-04; 

    % 81: R = 7.43
    params.Bl(8,1)  =  1.58e+00;
    params.Rms(8,1) =  3.54e-01;
    params.Mms(8,1) =  7.22e-04; 
    params.Cmc(8,1) =  2.14e-04; 
    % 82: R = 7.43
    params.Bl(8,2)  =  1.58e+00;
    params.Rms(8,2) =  3.54e-01;
    params.Mms(8,2) =  7.22e-04; 
    params.Cmc(8,2) =  2.14e-04; 
    ...
    for ii = 1:8
        ...
        params.muC(ii,jj) = (params.muC_tgt*params.Cmc(ii,jj))/params.Cmc(ii,jj); 
    ...
    %% CONTROL %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%% DOMAIN A
    params.kappa_A    = 0*(-params.Sd); % coupling (front pressure) MAX 1
    ...
    %%% DOMAIN A
    params.kappa_B    = 0*(-params.Sd); % coupling (front pressure) MAX 1

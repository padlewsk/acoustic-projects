function params = param_struct();
   ...
   % end
    ...
    params.A = 8; %% source amplitude (V) Tannoy: 0.02 (V)%Duct speaker:MAX 5V cf 20231129
    %constant
    ...
    params.avg_num_wind = 15; %The number of windows with 0% overlap (x2-1 for 50% overlap).RMK: SET 30 FOR CAL
    ...
    params.offset = 0;%-params.a/2; %m %shift of centre of unit cell wrt centre ( it doesn't matter...)
    %a = 0.055; %m
    %% CONTROL SENSITIVITY 
    %%% MIC  p(unitcell,atom)

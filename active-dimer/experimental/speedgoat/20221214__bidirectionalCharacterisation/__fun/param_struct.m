function params = param_struct();
    ...
    params.pb2disp_m = 2.14133e-05 ;  %Trasnferfunction between backpressure and displacement (m/V) *SN 65607
    params.pb2disp_p = 1.91082e-05;   %Trasnferfunction between backpressure and displacement (m/V) *SN 65609
    ...
    params.kappa = -0e-3; %0*(params.muC_m/params.Cmc_m);%(params.muC_m/params.Cmc_m); % 20221103 update - the control was inverted... 

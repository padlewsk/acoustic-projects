function params = param_struct()
    ...
    params.ts_acq = 100e-06; %% % sampling time (s) %%% CANNOT CHANGE ONCE FLASHED
    params.fs_acq = 1/params.ts_acq; 
     
    
    
    %% SOURCE GENERATOR %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    params.A = 0.5; %% source amplitude (V) Tannoy: 0.02 (V)%Duct speaker: 0.15 (V)
    ...
    %% CONTROL SENSITIVITY
    %%% MIC
    params.sens_p_c =  -20.00E-3;% (V/Pa) SN6969 
    params.sens_p_p =  -22.39E-3;% (V/Pa) SN6993
    params.sens_p_m =  -29.86E-3;% (V/Pa) SN5673 
    ...
    params.Bl_m  = 1.0837;
    params.Rms_m = 0.3708;
    params.Mms_m = 5.4332e-04;
    params.Cmc_m = 1.735e-04;%1.7502e-04;%
    ...
    params.Bl_p  = 1.3803;
    params.Rms_p = 0.3005;
    params.Mms_p = 6.1805e-04;
    params.Cmc_p = 1.705e-04;%1.7219e-04;%
    ...
    params.K = 0.01*(params.muC_p/params.Cmc_p); % SSH hopping parameter -1<0<1

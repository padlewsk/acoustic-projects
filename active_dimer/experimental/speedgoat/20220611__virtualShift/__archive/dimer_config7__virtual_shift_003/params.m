...
tg_model = 'Mobile'; %target select
MDL = 'SG__MDL_IO104'; % name of the slx model (performance)
%%% Sample time
...
ts = 40e-06; %% % sampling time (s) %%% CANNOT CHANGE ONCE FLASHED
fs = 1/ts; 
...
tmax = 2; %%20 sweep up measurement time (s) 

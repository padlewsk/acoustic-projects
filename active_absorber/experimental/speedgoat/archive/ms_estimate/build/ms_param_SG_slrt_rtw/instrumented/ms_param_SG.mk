...
MODEL           = ms_param_SG
MODULES         = rt_matrx.c rt_printf.c rt_logging.c ms_param_SG.c ms_param_SG_capi.c ms_param_SG_data.c ms_param_SG_xcp.c ms_param_SG_xcp_TET.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c host_timer_x86.c xpc_code_profiling_utility_functions.c sg_fpga_HDLCoder_io334_dac_sf_1.c sg_fpga_HDLCoder_io334_i2c_sf_1.c
MAKEFILE        = ms_param_SG.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = \\files7\data\padlewsk\My Documents\PhD_local\Projects\SpeedGoat\ms_param\build
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = ms_param_SG_ref.rsp
COMPILER_COMMAND_FILE     = ms_param_SG_comp.rsp
...
{C:\ProgramData\Speedgoat\hdlc\hcip\R2020a\sfunc}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{$(START_DIR)\ms_param_SG_slrt_rtw}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{$(MATLAB_ROOT)\rtw\c\src}.c.obj :
	@cmd /C "echo ### Compiling $<"
...
{$(START_DIR)\ms_param_SG_slrt_rtw}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<

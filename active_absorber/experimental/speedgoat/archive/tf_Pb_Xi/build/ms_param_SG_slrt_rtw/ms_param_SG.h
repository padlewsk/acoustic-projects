...
#ifndef RTW_HEADER_ms_param_SG_h_
#define RTW_HEADER_ms_param_SG_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#include "rtw_modelmap.h"
#ifndef ms_param_SG_COMMON_INCLUDES_
# define ms_param_SG_COMMON_INCLUDES_
...
#endif                                 /* ms_param_SG_COMMON_INCLUDES_ */

#include "ms_param_SG_types.h"
...
#define rtmGetRTWSolverInfo(rtm)       &((rtm)->solverInfo)
#define rtModel_ms_param_SG            RT_MODEL_ms_param_SG_T

/* Definition for use in the target main file */
#define ms_param_SG_rtModel            RT_MODEL_ms_param_SG_T

/* Block signals for system '<Root>/Highpass Filter2' */
typedef struct {
  real_T HighpassFilter2;              /* '<Root>/Highpass Filter2' */
} B_HighpassFilter2_ms_param_SG_T;

/* Block states (default storage) for system '<Root>/Highpass Filter2' */
typedef struct {
  b_dspcodegen_BiquadFilter_ms__T gobj_1;/* '<Root>/Highpass Filter2' */
  b_dspcodegen_BiquadFilter_ms__T gobj_2;/* '<Root>/Highpass Filter2' */
  dsp_HighpassFilter_ms_param_S_T obj; /* '<Root>/Highpass Filter2' */
  boolean_T objisempty;                /* '<Root>/Highpass Filter2' */
  boolean_T isInitialized;             /* '<Root>/Highpass Filter2' */
} DW_HighpassFilter2_ms_param_S_T;
...
typedef struct {
  ...
  B_HighpassFilter2_ms_param_SG_T HighpassFilter;/* '<Root>/Highpass Filter2' */
  B_HighpassFilter2_ms_param_SG_T HighpassFilter1;/* '<Root>/Highpass Filter2' */
  B_HighpassFilter2_ms_param_SG_T HighpassFilter2;/* '<Root>/Highpass Filter2' */
} B_ms_param_SG_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  b_dspcodegen_BiquadFilter_m_f_T gobj_1;/* '<Root>/Highpass Filter3' */
  b_dspcodegen_BiquadFilter_m_f_T gobj_2;/* '<Root>/Highpass Filter3' */
  dsp_HighpassFilter_ms_param_f_T obj; /* '<Root>/Highpass Filter3' */
  struct {
    real_T LAST_VALUE;
  ...
  DW_HighpassFilter2_ms_param_S_T HighpassFilter;/* '<Root>/Highpass Filter2' */
  DW_HighpassFilter2_ms_param_S_T HighpassFilter1;/* '<Root>/Highpass Filter2' */
  DW_HighpassFilter2_ms_param_S_T HighpassFilter2;/* '<Root>/Highpass Filter2' */
} DW_ms_param_SG_T;

/* Backward compatible GRT Identifiers */
#define rtB                            ms_param_SG_B
#define BlockIO                        B_ms_param_SG_T
#define rtP                            ms_param_SG_P
#define Parameters                     P_ms_param_SG_T
#define rtDWork                        ms_param_SG_DW
#define D_Work                         DW_ms_param_SG_T

/* Parameters (default storage) */
struct P_ms_param_SG_T_ {
...
extern P_ms_param_SG_T ms_param_SG_P;

/* Block signals (default storage) */
extern B_ms_param_SG_T ms_param_SG_B;

/* Block states (default storage) */
extern DW_ms_param_SG_T ms_param_SG_DW;

/*====================*
 * External functions *
 *====================*/
extern ms_param_SG_rtModel *ms_param_SG(void);
...
extern RT_MODEL_ms_param_SG_T *const ms_param_SG_M;
 ...
 *
 * '<Root>' : 'ms_param_SG'
 * '<S1>'   : 'ms_param_SG/IO334_IO'
 * '<S2>'   : 'ms_param_SG/Scope '
 * '<S3>'   : 'ms_param_SG/Scope 2'
 * '<S4>'   : 'ms_param_SG/IO334_IO/IO334_IO_FPGA'
 */
#endif                                 /* RTW_HEADER_ms_param_SG_h_ */
